...
describe("Search results sorting", function() {
  it("correctly arranges items when using 'by price' sorting", function() {
    ...
    let sortPriceButton = $(
      'btn btn-default,[href="http://ip-5236.sunline.net.ua:38015/search?query=duck&page=1&sort=price"]'
    );
  ...
  it("correctly arranges items when using 'by name' sorting", function() {
    ...
    let sortNamesButton = $(
      'btn btn-default,[href="http://ip-5236.sunline.net.ua:38015/search?query=duck&page=1&sort=name"]'
    );
  ...
  describe("Contact us form", function() {
    it("must send messages to shop administration", function() {
      ...
      assert(
        text.includes("Your email has successfully been sent"),
        "User send email success message is invalid"
      );
